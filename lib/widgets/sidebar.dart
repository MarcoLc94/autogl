...
class SidebarMenuState extends State<SidebarMenu> {
  ...
  Widget build(BuildContext context) {
    return Drawer(
      child: Container(
        color: Theme.of(context).colorScheme.primary, // Color de fondo dinámico
        child: Column(
          children: [
                  ...
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    return ListView(
                      children: [
                        ...
                        //     setState(() {
                        //       _isMenuExpanded =
                        //           expanded; // Actualiza el estado del submenú
                        //     });
                        //   },
                        //   children: [
                        //     // Subopción "Nominas"
                        //     _buildSubmenuItem(
                        //       index: 1, // Índice para la opción "Nominas"
                        //       title: 'Nominas',
                        //       icon: FontAwesomeIcons.fileInvoice,
                        //     ),
                        //     if (role ==
                        //         'admin') // Solo muestra "Personal" si el rol es admin
                        //       _buildSubmenuItem(
                        //         index: 2, // Índice para la opción "Personal"
                        //         title: 'Personal',
